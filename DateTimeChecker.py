...
from DTCLib import Config, is_valid_date, get_random_date, tkinter_set_text
...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.entry_day.grid(row=2, column=0, columnspan=1, padx=(20, 20), pady=(0, 20))
        ...
        self.entry_month.grid(row=2, column=1, columnspan=1, padx=(20, 20), pady=(0, 20))
        ...
        self.entry_year.grid(row=2, column=2, columnspan=1, padx=(20, 20), pady=(0, 20))
        ########### ROW 3
        self.btn_clear_entries = customtkinter.CTkButton(self, text="Clear", command=self.clear_entries_event)
        self.btn_clear_entries.grid(row=3, column=0, padx=40, pady=10)
    ...
    def check_date_event(self):
        ...
        is_valid_date(year=year, month=month, day=day)
